...
INTERNAL_TO_DEFAULTS_MAP = {
    SCInternal.LOCK_HEIGHT_MANUAL: SCInternalDefaults.LOCK_HEIGHT_VALUE.value,
    SCInternal.LOCK_ANGLE_MANUAL: SCInternalDefaults.LOCK_ANGLE_VALUE.value,
    SCInternal.NEUTRAL_POS_HEIGHT_MANUAL: SCInternalDefaults.NEUTRAL_POS_HEIGHT_VALUE.value,
    SCInternal.NEUTRAL_POS_ANGLE_MANUAL: SCInternalDefaults.NEUTRAL_POS_ANGLE_VALUE.value,
    SCInternal.SHADOW_BRIGHTNESS_THRESHOLD_MANUAL: SCInternalDefaults.SHADOW_BRIGHTNESS_THRESHOLD_VALUE.value,
    SCInternal.SHADOW_AFTER_SECONDS_MANUAL: SCInternalDefaults.SHADOW_AFTER_SECONDS_VALUE.value,
    SCInternal.SHADOW_SHUTTER_MAX_HEIGHT_MANUAL: SCInternalDefaults.SHADOW_SHUTTER_MAX_HEIGHT_VALUE.value,
    SCInternal.SHADOW_SHUTTER_MAX_ANGLE_MANUAL: SCInternalDefaults.SHADOW_SHUTTER_MAX_ANGLE_VALUE.value,
    SCInternal.SHADOW_SHUTTER_LOOK_THROUGH_SECONDS_MANUAL: SCInternalDefaults.SHADOW_SHUTTER_LOOK_THROUGH_SECONDS_VALUE.value,
    SCInternal.SHADOW_SHUTTER_OPEN_SECONDS_MANUAL: SCInternalDefaults.SHADOW_SHUTTER_OPEN_SECONDS_VALUE.value,
    SCInternal.SHADOW_SHUTTER_LOOK_THROUGH_ANGLE_MANUAL: SCInternalDefaults.SHADOW_SHUTTER_LOOK_THROUGH_ANGLE_VALUE.value,
    SCInternal.SHADOW_HEIGHT_AFTER_SUN_MANUAL: SCInternalDefaults.SHADOW_HEIGHT_AFTER_SUN_VALUE.value,
    SCInternal.SHADOW_ANGLE_AFTER_SUN_MANUAL: SCInternalDefaults.SHADOW_ANGLE_AFTER_SUN_VALUE.value,
    SCInternal.DAWN_BRIGHTNESS_THRESHOLD_MANUAL: SCInternalDefaults.DAWN_BRIGHTNESS_THRESHOLD_VALUE.value,
    SCInternal.DAWN_AFTER_SECONDS_MANUAL: SCInternalDefaults.DAWN_AFTER_SECONDS_VALUE.value,
    SCInternal.DAWN_SHUTTER_MAX_HEIGHT_MANUAL: SCInternalDefaults.DAWN_SHUTTER_MAX_HEIGHT_VALUE.value,
    SCInternal.DAWN_SHUTTER_MAX_ANGLE_MANUAL: SCInternalDefaults.DAWN_SHUTTER_MAX_ANGLE_VALUE.value,
    SCInternal.DAWN_SHUTTER_LOOK_THROUGH_SECONDS_MANUAL: SCInternalDefaults.DAWN_SHUTTER_LOOK_THROUGH_SECONDS_VALUE.value,
    SCInternal.DAWN_SHUTTER_OPEN_SECONDS_MANUAL: SCInternalDefaults.DAWN_SHUTTER_OPEN_SECONDS_VALUE.value,
    SCInternal.DAWN_SHUTTER_LOOK_THROUGH_ANGLE_MANUAL: SCInternalDefaults.DAWN_SHUTTER_LOOK_THROUGH_ANGLE_VALUE.value,
    SCInternal.DAWN_HEIGHT_AFTER_DAWN_MANUAL: SCInternalDefaults.DAWN_HEIGHT_AFTER_DAWN_VALUE.value,
    SCInternal.DAWN_ANGLE_AFTER_DAWN_MANUAL: SCInternalDefaults.DAWN_ANGLE_AFTER_DAWN_VALUE.value,
}
