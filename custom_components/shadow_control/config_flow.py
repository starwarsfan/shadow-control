...
YAML_CONFIG_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(SCInternal.SHADOW_CONTROL_ENABLED_MANUAL.value, default=True): cv.boolean,
        vol.Optional(SCShadowInput.CONTROL_ENABLED_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.SHADOW_BRIGHTNESS_THRESHOLD_MANUAL.value, default=50000): vol.Coerce(float),
        vol.Optional(SCShadowInput.BRIGHTNESS_THRESHOLD_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.SHADOW_AFTER_SECONDS_MANUAL.value, default=15): vol.Coerce(float),
        vol.Optional(SCShadowInput.AFTER_SECONDS_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.SHADOW_SHUTTER_MAX_HEIGHT_MANUAL.value, default=100): vol.Coerce(float),
        vol.Optional(SCShadowInput.SHUTTER_MAX_HEIGHT_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.SHADOW_SHUTTER_MAX_ANGLE_MANUAL.value, default=100): vol.Coerce(float),
        vol.Optional(SCShadowInput.SHUTTER_MAX_ANGLE_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.SHADOW_SHUTTER_LOOK_THROUGH_SECONDS_MANUAL.value, default=15): vol.Coerce(float),
        vol.Optional(SCShadowInput.SHUTTER_LOOK_THROUGH_SECONDS_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.SHADOW_SHUTTER_OPEN_SECONDS_MANUAL.value, default=15): vol.Coerce(float),
        vol.Optional(SCShadowInput.SHUTTER_OPEN_SECONDS_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.SHADOW_SHUTTER_LOOK_THROUGH_ANGLE_MANUAL.value, default=0): vol.Coerce(float),
        vol.Optional(SCShadowInput.SHUTTER_LOOK_THROUGH_ANGLE_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.SHADOW_HEIGHT_AFTER_SUN_MANUAL.value, default=0): vol.Coerce(float),
        vol.Optional(SCShadowInput.HEIGHT_AFTER_SUN_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.SHADOW_ANGLE_AFTER_SUN_MANUAL.value, default=0): vol.Coerce(float),
        vol.Optional(SCShadowInput.ANGLE_AFTER_SUN_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.DAWN_CONTROL_ENABLED_MANUAL.value, default=True): cv.boolean,
        vol.Optional(SCDawnInput.CONTROL_ENABLED_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.DAWN_BRIGHTNESS_THRESHOLD_MANUAL.value, default=500): vol.Coerce(float),
        vol.Optional(SCDawnInput.BRIGHTNESS_THRESHOLD_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.DAWN_AFTER_SECONDS_MANUAL.value, default=15): vol.Coerce(float),
        vol.Optional(SCDawnInput.AFTER_SECONDS_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.DAWN_SHUTTER_MAX_HEIGHT_MANUAL.value, default=100): vol.Coerce(float),
        vol.Optional(SCDawnInput.SHUTTER_MAX_HEIGHT_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.DAWN_SHUTTER_MAX_ANGLE_MANUAL.value, default=100): vol.Coerce(float),
        vol.Optional(SCDawnInput.SHUTTER_MAX_ANGLE_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.DAWN_SHUTTER_LOOK_THROUGH_SECONDS_MANUAL.value, default=15): vol.Coerce(float),
        vol.Optional(SCDawnInput.SHUTTER_LOOK_THROUGH_SECONDS_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.DAWN_SHUTTER_OPEN_SECONDS_MANUAL.value, default=15): vol.Coerce(float),
        vol.Optional(SCDawnInput.SHUTTER_OPEN_SECONDS_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.DAWN_SHUTTER_LOOK_THROUGH_ANGLE_MANUAL.value, default=0): vol.Coerce(float),
        vol.Optional(SCDawnInput.SHUTTER_LOOK_THROUGH_ANGLE_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.DAWN_HEIGHT_AFTER_DAWN_MANUAL.value, default=0): vol.Coerce(float),
        vol.Optional(SCDawnInput.HEIGHT_AFTER_DAWN_ENTITY.value): cv.entity_id,
        vol.Optional(SCInternal.DAWN_ANGLE_AFTER_DAWN_MANUAL.value, default=0): vol.Coerce(float),
