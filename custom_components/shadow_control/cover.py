...
from .const import (
    ...
    DOMAIN,
    #    
    STATE_SHADOW_FULL_CLOSE_TIMER_RUNNING,
    STATE_SHADOW_FULL_CLOSED,
    STATE_SHADOW_HORIZONTAL_NEUTRAL_TIMER_RUNNING,
    STATE_SHADOW_HORIZONTAL_NEUTRAL,
    STATE_SHADOW_NEUTRAL_TIMER_RUNNING,
    STATE_SHADOW_NEUTRAL,
    STATE_NEUTRAL,
    STATE_DAWN_NEUTRAL,
    STATE_DAWN_NEUTRAL_TIMER_RUNNING,
    STATE_DAWN_HORIZONTAL_NEUTRAL,
    STATE_DAWN_HORIZONTAL_NEUTRAL_TIMER_RUNNING,
    STATE_DAWN_FULL_CLOSED,
    STATE_DAWN_FULL_CLOSE_TIMER_RUNNING,
)
